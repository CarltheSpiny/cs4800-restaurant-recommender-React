      ...
      <header data-thq="thq-navbar" className="page-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="page-desktop-menu">
          <nav className="page-links">
            <span>About</span>
            <span className="page-text01">Features</span>
            <span className="page-text02">Pricing</span>
            <span className="page-text03">Team</span>
            <span className="page-text04">Blog</span>
          </nav>
        ...
        <div data-thq="thq-mobile-menu" className="page-mobile-menu">
          <div className="page-nav">
            ...
            <nav className="page-links1">
              <span className="page-text05">About</span>
              <span className="page-text06">Features</span>
              <span className="page-text07">Pricing</span>
              <span className="page-text08">Team</span>
              <span className="page-text09">Blog</span>
            </nav>
            <div className="page-buttons1">
              <button className="page-login1 button">Login</button>
              <button className="button">Register</button>
            </div>
          </div>
          <div>
